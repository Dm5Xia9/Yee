...
{
    public class AbilityIdentityDbContext : IdentityDbContext<AbilityUser, AbilityRole, IDKEY, AbilityUserClaim, AbilityUserRole, AbilityUserLogin, AbilityRoleClaim, AbilityUserToken>
    {
        public AbilityIdentityDbContext(IDbContextOptionsProvider provider) : 
            base(provider.GetOptions())
        {
        }
